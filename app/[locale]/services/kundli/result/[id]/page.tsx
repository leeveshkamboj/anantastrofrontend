      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardContent className="pt-8 pb-8 text-center">
            ...
            <Button className="mt-4" variant="outline" onClick={() => router.push('/services/kundli/generate')}>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardContent className="pt-8 pb-8 text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">{gen.errorMessage || tc('genericError')}</p>
            <Button variant="outline" onClick={() => router.push('/services/kundli/generate')}>
              <ArrowLeft className="h-4 w-4 mr-2" />
              {t('backToKundli')}
            </Button>
          </CardContent>
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900">{t('yourKundli')}</h1>
              <p className="text-gray-600 text-sm">
