      ...
      {activeTab === 'dashboard' && (
        <>
          <ReportLanguageSwitch
            ...
            priceCoinCost={interpretTranslation.priceCoinCost}
            priceIsFree={interpretTranslation.priceIsFree}
              ...
              {isReady ? (
                <>
                  <ReportLanguageSwitch
                    ...
                    priceCoinCost={addonTranslation.priceCoinCost}
                    priceIsFree={addonTranslation.priceIsFree}
