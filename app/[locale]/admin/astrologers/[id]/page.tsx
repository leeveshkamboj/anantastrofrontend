...
export default function AdminAstrologerDetailPage() {
  ...
  const handleToggleActive = async () => {
    try {
      ...
      toast.error(error?.data?.message || t('statusUpdateFailed'));
    }
  };
  ...
  const handleApproveProfile = async () => {
    try {
      ...
      toast.error(error?.data?.message || t('approveFailed'));
    }
  };

  const handleRejectProfile = async () => {
    if (!rejectReason.trim()) {
      toast.error(t('rejectionReasonProfile'));
      return;
    }
    try {
      ...
      toast.error(error?.data?.message || t('rejectFailed'));
    }
  };
  ...
  const handleApproveAllPricing = async () => {
    try {
      ...
      toast.error(error?.data?.message || t('pricingApproveAllFailed'));
    }
  };
  ...
  const handleApproveServicePricing = async (serviceType: string) => {
    try {
      ...
      toast.success(t('pricingApprovedSingle', { serviceType }));
      refetch();
    } catch (error: any) {
      toast.error(error?.data?.message || t('pricingApproveOneFailed'));
    }
  };
  ...
  const handleRejectPricingSubmit = async () => {
    if (!rejectReason.trim()) {
      toast.error(t('pricingRejectionReason'));
      return;
    }
    try {
      await rejectPricing({
      ...
      toast.error(error?.data?.message || t('pricingRejectFailed'));
    }
  };
